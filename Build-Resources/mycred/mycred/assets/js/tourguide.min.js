...
var mycred_tour_data = [
    [
        {
            title: 'General Settings' + '<span class=num>1 of 7</span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
            ...
            attachTo: { 
            element: '#toplevel_page_mycred-main .current', 
            on: 'left'
            },
            buttons: [
                {
    ...
    [
        {
            title: 'Singular'+ '<span class=num>2 of 7</span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
        ...
        {
            title: 'Plural'+ '<span class=num>3 of 7</span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
        ...
        {
            title: 'Prefix'+ '<span class=num>4 of 7</span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
    ...
    [
        {
            title: 'Log' + '<span class=num>5 of 7</span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
    ...
    [
        {
            title: 'Hooks' + '<span class=num>6 of 7</span><span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
    ...
    [
        {
            title: 'Add-ons' + '<span class=num>7 of 7</span><span class="dashicons dashicons-dismiss cancel" onclick="myTour.cancel()"></span>',
            text: 'myCred comes with multiple built-in add-ons for expanding installation with additional features, such as transfers, notifications, statistics, buyCred, cashCred, and much more.',
            attachTo: { 
            element: '#toplevel_page_mycred .current', 
            on: 'left'
...
jQuery(function($) {
	...
	if ( typeof mycred_tour_guide !== 'undefined' && typeof mycred_tour_guide.step !== 'undefined' ) {
		...
		if ( mycred_tour_guide.step == 1 || mycred_tour_guide.step == 2) {
