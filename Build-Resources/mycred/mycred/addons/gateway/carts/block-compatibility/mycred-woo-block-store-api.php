...
class myCred_Woo_Gateway_Extend_Store_Endpoint {
	 ...
	 * @var string
	 */
	const IDENTIFIER = 'mycredwoogateway';
	...
	public static function init() {
		...
		woocommerce_store_api_register_endpoint_data(
			array(
				...
				'data_callback'   => array( 'myCred_Woo_Gateway_Extend_Store_Endpoint', 'extend_checkout_block_data' ),
				'schema_callback' => array( 'myCred_Woo_Gateway_Extend_Store_Endpoint', 'extend_checkout_block_schema' ),
				'schema_type'     => ARRAY_A,
			)
		);
