...
class LeaderBoardHelper
{
    public static function getLeaderBoard($lastDays = 0, $limit = 10, $cached = false)
    {
        ...
        if ($lastDays) {
            $currentTimeStamp = current_time('timestamp');
            $dateRange = [date('Y-m-d 00:00:00', ($currentTimeStamp - $lastDays * DAY_IN_SECONDS)), gmdate('Y-m-d 23:59:59', $currentTimeStamp)];
        }
    ...
    public static function getDynamicLevels()
    {
        ...
        $defaults = [
            'level_1' => [
                ...
                'tagline'    => 'Taking the first steps into our vibrant world',
                'slug'       => 'level_1',
                'level'      => 1,
                'min_points' => 0,
                'max_points' => 4
            ...
            'level_2' => [
                ...
                'tagline'    => 'Uncovering the secrets of community mastery',
                'slug'       => 'level_2',
                'level'      => 2,
                'min_points' => 5,
                'max_points' => 19
            ...
            'level_3' => [
                ...
                'tagline'    => 'Igniting passion and fostering connections',
                'slug'       => 'level_3',
                'level'      => 3,
                'min_points' => 20,
                'max_points' => 64
            ...
            'level_4' => [
                ...
                'tagline'    => 'Weaving the fabric of shared knowledge',
                'slug'       => 'level_4',
                'level'      => 4,
                'min_points' => 65,
                'max_points' => 154
            ...
            'level_5' => [
                ...
                'tagline'    => 'Championing the cause with unwavering spirit',
                'slug'       => 'level_5',
                'level'      => 5,
                'min_points' => 155,
                'max_points' => 499
            ...
            'level_6' => [
                ...
                'tagline'    => 'Exemplifying mastery and skill',
                'slug'       => 'level_6',
                'level'      => 6,
                'min_points' => 500,
                'max_points' => 1999
            ...
            'level_7' => [
                ...
                'tagline'    => 'Imparting wisdom and guiding the way',
                'slug'       => 'level_7',
                'level'      => 7,
                'min_points' => 2000,
                'max_points' => 7999
            ...
            'level_8' => [
                ...
                'tagline'    => 'Leading with bold innovation and vision',
                'slug'       => 'level_8',
                'level'      => 8,
                'min_points' => 8000,
                'max_points' => 24999
            ...
            'level_9' => [
                ...
                'tagline'    => 'Eternally inspiring excellence and unity',
                'slug'       => 'level_9',
                'level'      => 9,
                'min_points' => 25000,
