...
use FluentCommunity\Framework\Container\Container;
...
use FluentCommunity\Framework\Database\MultipleRecordsFoundException;
use FluentCommunity\Framework\Pagination\Cursor;
use FluentCommunity\Framework\Pagination\Paginator;
use FluentCommunity\Framework\Pagination\CursorPaginator;
use FluentCommunity\Framework\Pagination\LengthAwarePaginator;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\FluentCommunity\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \FluentCommunity\Framework\Support\Collection<int, TReturn>
     */
    ...
    public function chunkByIdDesc($count, callable $callback, $column = null, $alias = null)
    {
        return $this->orderedChunkById(
            $count, $callback, $column, $alias, true
        );
    }
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Query\Builder|\FluentCommunity\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \FluentCommunity\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \FluentCommunity\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \FluentCommunity\Framework\Pagination\CursorPaginator
     */
