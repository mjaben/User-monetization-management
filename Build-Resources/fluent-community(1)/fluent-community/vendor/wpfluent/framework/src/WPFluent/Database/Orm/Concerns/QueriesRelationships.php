...
trait QueriesRelationships
{
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Relations\Relation|string  $relation
    ...
    public function has($relation, $operator = '>=', $count = 1, $boolean = 'and', ?Closure $callback = null)
    {
        ...
        // proper logical grouping of the where clauses if needed by this Orm query
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Relations\MorphTo|string  $relation
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Relations\MorphTo  $relation
     * @param  string  $type
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Relations\MorphTo|string  $relation
     * @param  \FluentCommunity\Framework\Database\Orm\Model|string  $model
     * @return \FluentCommunity\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Model  $related
     ...
     *
     * @param  string  $column
     * @param  \FluentCommunity\Framework\Database\Orm\Relations\Relation<*, *, *>  $relation
     * @return string
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Builder  $hasQuery
     * @param  \FluentCommunity\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Builder  $from
     * @return \FluentCommunity\Framework\Database\Orm\Builder|static
     */
