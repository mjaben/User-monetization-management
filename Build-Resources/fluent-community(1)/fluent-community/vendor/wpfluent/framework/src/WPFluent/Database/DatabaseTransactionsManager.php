...
class DatabaseTransactionsManager
{
     ...
     *
     * @var \FluentCommunity\Framework\Support\Collection<int, \FluentCommunity\Framework\Database\DatabaseTransactionRecord>
     */
    ...
    public function commit($connection, $levelBeingCommitted, $newTransactionLevel)
    {
        ...
        // This method is only called when the root database transaction is 
        // committed so there shouldn't be any pending transactions, but
        // going to clear them here anyways just in case. This method
        // could be refactored to receive a level in the future too.
    ...
    /**
     * Remove all pending, completed, and current transactions
     ...
     *
     * @param  \FluentCommunity\Framework\Database\DatabaseTransactionRecord  $transaction
     * @return void
     */
    protected function removeCommittedTransactionsThatAreChildrenOf(DatabaseTransactionRecord $transaction)
    {
        ...
        // There may be multiple deeply nested transactions that have already 
        // committed that we also need to remove. We will recurse down the
        // children of all removed transaction instances until there are
        // no more deeply nested child transactions for removal.
     ...
     *
     * @return \FluentCommunity\Framework\Support\Collection<int, \FluentCommunity\Framework\Database\DatabaseTransactionRecord>
     */
     ...
     * for the given transaction level.
     *
     * @param  int  $level
     * @return bool
     */
