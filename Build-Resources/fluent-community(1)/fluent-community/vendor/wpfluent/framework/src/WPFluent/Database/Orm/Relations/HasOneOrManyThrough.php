...
use FluentCommunity\Framework\Database\Orm\SoftDeletes;
...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Model| \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentCommunity\Framework\Database\Orm\Model|\FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
