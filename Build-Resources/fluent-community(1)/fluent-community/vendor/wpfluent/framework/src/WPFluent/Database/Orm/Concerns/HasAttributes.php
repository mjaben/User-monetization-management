...
use FluentCommunity\Framework\Database\Orm\Casts\Attribute;
use FluentCommunity\Framework\Database\Orm\Castable;
use FluentCommunity\Framework\Database\Orm\Casts\AsCollection;
use FluentCommunity\Framework\Database\Orm\Casts\AsArrayObject;
use FluentCommunity\Framework\Database\Orm\Relations\Relation;
use FluentCommunity\Framework\Database\Orm\InvalidCastException;
use FluentCommunity\Framework\Database\Orm\JsonEncodingException;
use FluentCommunity\Framework\Database\LazyLoadingViolationException;
use FluentCommunity\Framework\Database\Orm\CastsInboundAttributes;
use FluentCommunity\Framework\Support\Collection as BaseCollection;
use FluentCommunity\Framework\Database\Orm\MissingAttributeException;
...
trait HasAttributes
{
    ...
    /**
     * The built-in, primitive cast types supported by Orm.
     *
     * @var string[]
     */
     ...
     *
     * @var \FluentCommunity\Framework\Encryption\Encrypter
     */
    ...
    protected function addCastAttributesToArray(array $attributes, array $mutatedAttributes)
    {
        foreach ($this->getCasts() as $key => $value) {
            ...
            // to strings based on the date format specified for these Orm models.
            ...
            if ($this->isEnumCastable($key) && (! ($attributes[$key] ?? null) instanceof ArrayableInterface)) {
                $attributes[$key] = isset($attributes[$key]) ? $attributes[$key]->value : null;
            }

            if ($attributes[$key] instanceof ArrayableInterface) {
     ...
     * @return null
     *
     * @throws \FluentCommunity\Framework\Database\Orm\MissingAttributeException
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        return Helper::tap($relation->getResults(), function ($results) use ($method) {
     ...
     *
     * @param  \FluentCommunity\Framework\Encryption\Encrypter  $encrypter
     * @return void
     */
     ...
     * @return bool
     *
     * @throws \FluentCommunity\Framework\Database\Orm\InvalidCastException
     */
