...
namespace FluentCommunity\Framework\Validator;
...
use FluentCommunity\Framework\Validator\Rules\In;
use FluentCommunity\Framework\Validator\Rules\NotIn;
use FluentCommunity\Framework\Validator\Rules\Unique;
use FluentCommunity\Framework\Validator\Rules\Exists;
use FluentCommunity\Framework\Validator\Rules\RequiredIf;
use FluentCommunity\Framework\Validator\Rules\Dimensions;
use FluentCommunity\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \FluentCommunity\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \FluentCommunity\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentCommunity\Framework\Validator\Rules\Exists
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentCommunity\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentCommunity\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \FluentCommunity\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentCommunity\Framework\Validator\Rules\Unique
     */
