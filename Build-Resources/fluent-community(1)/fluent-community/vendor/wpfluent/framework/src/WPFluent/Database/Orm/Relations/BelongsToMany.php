...
use FluentCommunity\Framework\Database\Orm\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\FluentCommunity\Framework\Database\Query\Expression>
     */
     ...
     *
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\FluentCommunity\Framework\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @return \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     *
     * @throws \FluentCommunity\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return \FluentCommunity\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|TValue
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentCommunity\Framework\Pagination\Paginator
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \FluentCommunity\Framework\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \FluentCommunity\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @return \FluentCommunity\Framework\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \FluentCommunity\Framework\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \FluentCommunity\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\FluentCommunity\Framework\Database\Query\Expression  $column
     * @return string|\FluentCommunity\Framework\Database\Query\Expression
     */
