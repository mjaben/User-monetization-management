...
use FluentCommunity\Framework\Database\Orm\SupportsPartialRelations;
use FluentCommunity\Framework\Database\Orm\Relations\Concerns\CanBeOneOfMany;
...
class MorphOne extends MorphOneOrMany implements SupportsPartialRelations
{
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Query\JoinClause  $join
     * @return void
     */
