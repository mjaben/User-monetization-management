...
use FluentCommunity\Framework\Support\HelperFunctionsTrait;
use FluentCommunity\Framework\Database\Query\Expression;
use FluentCommunity\Framework\Database\Concerns\BuildsQueries;
use FluentCommunity\Framework\Database\RecordsNotFoundException;
use FluentCommunity\Framework\Database\Orm\Relations\Relation;
use FluentCommunity\Framework\Database\Orm\Relations\BelongsToMany;
use FluentCommunity\Framework\Database\Orm\RelationNotFoundException;
use FluentCommunity\Framework\Database\Orm\Concerns\QueriesRelationships;
use FluentCommunity\Framework\Database\UniqueConstraintViolationException;
use FluentCommunity\Framework\Database\Query\Builder as QueryBuilder;

/**
 * @property-read HigherOrderBuilderProxy $orWhere
 *
 * @mixin \FluentCommunity\Framework\Database\Query\Builder
 *
 * @template TModel of \FluentCommunity\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \FluentCommunity\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentCommunity\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \FluentCommunity\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \FluentCommunity\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \FluentCommunity\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\FluentCommunity\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentCommunity\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentCommunity\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \FluentCommunity\Framework\Database\Orm\Collection
     */
    public function hydrate(array $items, $args = [])
    {
        $instance = $this->newModelInstance();

        return $instance->newCollection(array_map(function ($item) use ($items, $instance, $args) {
            $model = $instance->newFromBuilder($item, null, $args);
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Model|\FluentCommunity\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  \FluentCommunity\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Model|\FluentCommunity\Framework\Database\Orm\Collection|static|static[]
     *
     * @throws \FluentCommunity\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @return TModel|TValue|\FluentCommunity\Framework\Database\Orm\Collection
     */
     ...
     * @return \FluentCommunity\Framework\Database\Orm\Model|static|mixed
     */
     ...
     * @return \FluentCommunity\Framework\Database\Orm\Model
     *
     * @throws \FluentCommunity\Framework\Database\Orm\ModelNotFoundException
     ...
     * @return mixed
     *
     * @throws \FluentCommunity\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentCommunity\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \FluentCommunity\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentCommunity\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \FluentCommunity\Framework\Pagination\LengthAwarePaginator
     *
     ...
     * @return \FluentCommunity\Framework\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array  $attributes
     * @return \FluentCommunity\Framework\Database\Orm\Model|$this
     */
    public function create(array $attributes = [])
    {
        $instance = $this->newModelInstance($attributes);

        return Helper::tap($instance, function ($instance) {
            $instance->save();
        });
    }
     ...
     *
     * @param  array|\FluentCommunity\Framework\Database\Query\Expression  $columns
     * @return array
     */
